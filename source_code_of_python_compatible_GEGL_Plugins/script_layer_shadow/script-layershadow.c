...
enum_start (gegl_gimplayershadow_grow_shapex)
...
enum_end (GeglgimplayershadowGrowShapex)
...
property_enum   (growshape, _("Grow shape"),
                 GeglgimplayershadowGrowShapex, gegl_gimplayershadow_grow_shapex,
...
#define GEGL_OP_META
#define GEGL_OP_NAME     script_layershadow
#define GEGL_OP_C_SOURCE script-layershadow.c
