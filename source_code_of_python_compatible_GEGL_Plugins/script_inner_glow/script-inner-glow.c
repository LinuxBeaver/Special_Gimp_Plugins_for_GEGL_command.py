...
enum_end (innerglowlistx)

property_enum (mode, _("Mode:"),
               innerglowlistx, inner_glow_listx,
               DEFAULT_IG)
...
enum_start (gegl_dropshadow_grow_shapeigx)
...
enum_end (GeglDropshadowGrowShapeigx)


property_enum   (grow_shape, _("Grow shape"),
                 GeglDropshadowGrowShapeigx, gegl_dropshadow_grow_shapeigx,
...
#define GEGL_OP_META
#define GEGL_OP_NAME     script_inner_glow
#define GEGL_OP_C_SOURCE script-inner-glow.c
