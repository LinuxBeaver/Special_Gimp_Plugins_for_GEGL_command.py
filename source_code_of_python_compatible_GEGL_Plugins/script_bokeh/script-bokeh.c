...
enum_start (gegl_median_blur_neighborhoodox)
...
enum_end (GeglMedianBlurNeighborhoodox)


property_enum (neighborhood, _("Shape"),
               GeglMedianBlurNeighborhoodox, gegl_median_blur_neighborhoodox,
...
#define GEGL_OP_META
#define GEGL_OP_NAME     script_bokeh
#define GEGL_OP_C_SOURCE script-bokeh.c
