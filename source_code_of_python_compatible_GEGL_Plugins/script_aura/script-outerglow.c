...
enum_end (GeglMosaicTile2x)

property_enum (tile_type, _("Base Mosaic Mode Flame shape"),
    GeglMosaicTile2x, gegl_mosaic_tile2x, GEGL_MOSAIC_TILE_TRIANGLES2)
...
#define GEGL_OP_META
#define GEGL_OP_NAME     script_outerglow
#define GEGL_OP_C_SOURCE script-outerglow.c
