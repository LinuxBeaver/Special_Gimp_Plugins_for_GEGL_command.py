...
enum_start (gegl_video_degradation_fork_typex)
  ...
  enum_value (GEGL_VIDEO_DEGRADATION_TYPE_DOTS, "dots",
              N_("Dots"))
enum_end (GeglVideoDegradationForkTypex)

property_enum (pattern, _("Pattern"), GeglVideoDegradationForkTypex,
               gegl_video_degradation_fork_typex,
...
#define GEGL_OP_META
#define GEGL_OP_NAME     script_video_degradation_mod
#define GEGL_OP_C_SOURCE script-video-degradation-mod.c
...
gegl_op_class_init (GeglOpClass *klass)
{
  ...
  gegl_operation_class_set_keys (operation_class,
    "name",        "lb:script-video-degradation-mod",
